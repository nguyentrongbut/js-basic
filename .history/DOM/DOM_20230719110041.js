...
// 2.3 document.getElementByClassName -> trả về 1 HTMLCollection chứa danh sách các node, nếu không trả về empty
const classNode = document.getElementsByClassName("h")