...
// 2.3 document.getElementsByClassName("className") -> trả về 1 HTMLCollection chứa danh sách các node, nếu không trả về empty
const classNode = document.getElementsByClassName("items");
// console.log(classNode);
// 2.4 document.getElementsByTagName("tagName") -> trả về HTMLCollection chứa các danh sách node, nếu không có thì trả về empty []
const tagNodes = document.getElementsByTagName("li");
console.log(tagNodes);
// 2.5 document.getElementsById("id") -> trả về 1 node
const idNode = document.getElementById("spin")