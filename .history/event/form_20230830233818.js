...
//     console.log(e.key);
    ...
    //     // e.preventDefault();; không sử dụng được
    //     // return;
    // } else {
    //     console.log(e.key);
    // }
...
//     console.log(e.key);
    // e.preventDefault();; không sử dụng được vì không hiểu hành động nhả ra 
// })
...
form.addEventListener("submit", function(e) {
    e.preventDefault();
    // if (input.value === "") {
    //     alert("u can not make empty input");
    // }
    ...
    // // const hobby = this.elements["hobby"].value không dùng được
    ...
    // stuck -> bị bí
    // xử lý buộc user nhập username và password
    const username = this.elements["username"].value;
    if (!username) alert("please enter your")
});
// Validation
// email: abc@gmail.com
// Regular expression