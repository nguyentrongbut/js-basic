...
reverseNumber(-1234);
reverseNumber(1234);
// 4. Viết chương trình có tên là fizzBuzz với đầu vào là 1 số nguyên, và cho chạy từ 1 cho tới số nguyên đó rồi kiểm tra nếu số chia hết cho 2 thì in ra chữ "f"