...
// Chỉ trả về true khi tất cả đều đúng 1 cái sai sẽ là false
...
// initialize value (giá trị khởi tạo ban đầu)
const totalNumber = listNumber.reduce(function(previousValues, b) {
    console.log(previousValues, b);
    return previousValues + b;
}, 0);
