...
function timeSince(date) {
    ...
    console.log(timer);
    if (timer > 1) {
        console.log(`${Math.floor} last year`);
    }
    timer = seconds / 2678400;
    if (timer > 1) {
        console.log(`${Math.floor} last month`);
    }
    timer = seconds / 604800;
    if (timer > 1) {
        console.log(`${Math.floor} last week`);
    }
    timer = seconds / 86400;
    if (timer > 1) {
        console.log(`${Math.floor} last day`);
    }
    timer = seconds / 3600;
    if (timer > 1) {
        console.log(`${Math.floor} last hours`);
    }
    timer = seconds / 60;
    if (timer > 1) {
        console.log(`${Math.floor} last minutes`);
    }
}
