...
let Hello = sayHello2(); // chạy return 
Hello(); // chạy 
...
let hello = sayHello3("Welcome to JS"); // trả về fn hiYourName nhưng chưa gọi ctrinh chưa chạy
hello("Closure"); //chạy chương trình Welcome to JS Closure

// Arrow function: anonymous function (2015) không bị hoisting
// ECMAScript
// Normal function
