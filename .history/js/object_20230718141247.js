...
const student2 = {
    ...
    // fullname: {
    //     name: "Nguyen Trong But",
    // },
};
student2.hi();
// optional chaining
console.log(student2.fullname); //undefined
// console.log(student2.fullname.name); //undefined.name -> Cannot read properties of undefined (reading 'name')
...
whatYourInfo(newObj);
// object destructing paremeter
function whatYourInfo2({name, })